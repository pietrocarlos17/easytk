...
(function () {
  ...
  function trackAddToCart() {
    try { if (window.fbq) fbq('track', 'AddToCart', { content_name: PRODUCT.name, content_type: 'product', value: PRODUCT.price, currency: 'EUR' }); } catch (e) {}
    try { if (window.ttq) ttq.track('AddToCart', { content_name: PRODUCT.name, content_type: 'product', value: PRODUCT.price, currency: 'EUR' }); } catch (e) {}
  }
  ...
  function pickCheckoutUrl(q) {
    ...
    var cycleStart = Date.UTC(2026, 5, 20, 23, 0, 0); // dom 00:00 BST = sáb 23:00 UTC
  ...
  if (checkout) checkout.addEventListener('click', () => {
    ...
    try { if (window.fbq) fbq('track', 'InitiateCheckout', { content_name: PRODUCT.name, value: PRODUCT.price * q, currency: 'EUR', num_items: q }); } catch (e) {}
    try { if (window.ttq) ttq.track('InitiateCheckout', { content_name: PRODUCT.name, value: PRODUCT.price * q, currency: 'EUR', quantity: q }); } catch (e) {}
