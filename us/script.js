...
(function () {
  ...
  function trackAddToCart() {
    try { if (window.fbq) fbq('track', 'AddToCart', { content_name: PRODUCT.name, content_type: 'product', value: PRODUCT.price, currency: 'USD' }); } catch (e) {}
    try { if (window.ttq) ttq.track('AddToCart', { content_name: PRODUCT.name, content_type: 'product', value: PRODUCT.price, currency: 'USD' }); } catch (e) {}
  }
  ...
  if (checkout) checkout.addEventListener('click', () => {
    ...
    try { if (window.fbq) fbq('track', 'InitiateCheckout', { content_name: PRODUCT.name, value: PRODUCT.price * q, currency: 'USD', num_items: q }); } catch (e) {}
    try { if (window.ttq) ttq.track('InitiateCheckout', { content_name: PRODUCT.name, value: PRODUCT.price * q, currency: 'USD', quantity: q }); } catch (e) {}
